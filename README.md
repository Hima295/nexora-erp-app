...
1. **ERPNext Core Untouched**: Zero direct modifications to ERPNext source code. All extensions, custom fields, and document hooks are declared non-invasively inside `nexora/hooks.py` and fixtures.
...
# 2. Get the nexora custom application
bench get-app https://github.com/nexora-org/nexora.git --branch main

# 3. Install nexora on your target ERPNext site
bench --site [your-site-name] install-app nexora
...
```bash
# Build and run the complete Frappe + ERPNext + nexora container stack
cd nexora
...
└── nexora/                  # App Python package
    ...
    ├── nexora_core/         # Core Single Settings & System Log DocTypes
...
- **nexora Core**: App configuration, audit logging, and ERPNext observer hooks.
